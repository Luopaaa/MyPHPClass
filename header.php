        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    {
                        echo "<li>";
                        echo "<a href=\"ShowALLData_admin.php\">航班總攬</a>";
                        echo "</li>";
                        echo "<li>";
                        echo "<a href=\"prodinput_front.php\">新增航班</a>";
                        echo "</li>";
                        echo "<li>";
                    ...
                    else
                    {
                        ...
                        echo "</li>";
                        echo "<li>";
                        echo "<a href=\"MyTrip.php\">My Trip</a>";
                        echo "</li>";
                        echo "<li>";
                        echo "<a href=\"ShowAllData.php\">Buy Ticket</a>";
                        echo "</li>";
                        echo "<li>";
                        echo "<a href=\"logout.php\">Log Out</a>";
                        echo "</li>";
